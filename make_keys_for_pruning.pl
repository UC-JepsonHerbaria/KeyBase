...
#NB> This currently ignores embedded keys to infraspecific taxa

 
$/="";
#OPEN THE RAW FILE
$treatments="eflora_treatments.txt";
...
#RECOGNIZE GENUS PARAGRAPHS
		...
		if($key_number-$i == 1){
			...
			print "GENUS KEY FOR $genus\n$modified_key\n\n";
#GENERA WITH KEYS ARE REMEMBERED
